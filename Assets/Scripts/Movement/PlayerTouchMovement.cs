...
{
    [SerializeField]
    private Vector2 JoystickSize = new Vector2(150, 150);
    [SerializeField]
    ...
    public event Action OnLoseFinger;
    ...
    {
        if (MovementFinger == null && TouchedFinger.screenPosition.x <= Screen.width / 1f && TouchedFinger.screenPosition.y <= Screen.height / 1.3f)
        {
